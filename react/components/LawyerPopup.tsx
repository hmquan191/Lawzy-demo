...
const LawyerPopup: React.FC<LawyerPopupProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className=' font-sans fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30 backdrop-blur-sm '>
      {showMap ? (
          ...
          {selectedLawyer ? (
            ...
            <div className='flex h-[500px]'>
              ...
              <div className='w-2/3 p-6 flex flex-col'>
                <div className='flex items-center mb-4'>
                  <button onClick={handleBackToList} className='mr-2 p-1 rounded-full hover:bg-gray-100'></button>
            ...
            <>
              <div className='p-4 border-b border-gray-200 flex items-center justify-between bg-[#fc8e5a] text-white rounded-t-lg'>
                ...
                <button onClick={onClose} className='p-1 hover:bg-[#fc8e5a]/90 rounded'>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    className='h-6 w-6'
                    fill='none'
              ...
              <div className='p-4 border-t border-gray-200 flex gap-3 bg-[#fefff9] rounded-b-lg'>
                ...
                <button className='flex-1 py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg'>
                  Xem tất cả luật sư
                </button>
              </div>
            </>
